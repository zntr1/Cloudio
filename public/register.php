...
<div class="grid">
    ...
    <form action="../script/registration.php" method="POST" class="form login">
        ...
        <div class="form__field">
            ...
            <input id="registration_email" name="email" class="form__input" placeholder="E-Mail" required>
        </div>
        <div class="form__field">
            ...
            <input id="registration_plz" type="text" name="plz" class="form__input" placeholder="PLZ" required>
        </div>
        <div class="form__field">
